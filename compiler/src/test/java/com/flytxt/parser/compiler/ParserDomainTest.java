...
public class ParserDomainTest {
    ...
    public void compileNtest() throws Exception {
        ...
        absProcessor = "protected Marker mzxcswewq;protected byte[] token_124= \"|\".getBytes();private Store store = new ConsoleStore(\"/tmp/output\");public final String regex=\"(.*)GJC(.*)\";";
