...
public class ParserDomainTest {
    ...
    public void compileNtest() throws Exception {
        ...
        name = "TestScript";
        init = "store.set(\"TestScript\");this.mf.setMaxListSize(1);";
        absProcessor = "protected Marker mzxcswewq;protected byte[] token_124= \"|\".getBytes();private Store store = new ConsoleStore(\"test\");";
