...
public class TpString {
    ...
    public Marker length(Marker m, MarkerFactory mf) {
        byte[] markerLength = String.valueOf(m.length).getBytes();
        return mf.createMarker(markerLength, 0, markerLength.length);
        // will it come index-length
    }
